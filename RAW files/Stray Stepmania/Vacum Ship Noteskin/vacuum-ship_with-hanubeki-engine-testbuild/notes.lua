...
--Whoops, I modded it! sorry about that! -JOELwindows7-
...
Column Color Reference (+1 for white outline):
	...
	for i, quantum in ipairs(activeState.quanta) do
		local states= {}
		...
		columns[i] = {
			...
			taps = {
				NewSkinTapPart_Tap = {
					...
					actor = Def.Sprite {
						Texture = NEWSKIN:get_path(skin_name, buttonInfo.tap.image .. " Tap Note 8x8.png"),
				...
				NewSkinTapPart_Lift = {
					...
					actor = Def.Sprite {
						Texture = liftType == "Arrow" and NEWSKIN:get_path(skin_name, buttonInfo.tap.image .. " Tap Note 8x8.png")
			...
			holds = {
				TapNoteSubType_Hold = {
					{
						...
						textures = {buttonInfo.hold.image .. " Hold 8x4.png"},
				...
				TapNoteSubType_Roll = {
					{
						state_map = inactiveState,
						textures = {buttonInfo.roll.image .. " Roll 8x4.png"},
...
--[[
			...
			reverse_holds = {
				TapNoteSubType_Hold = {
					{
						state_map = inactiveState,
						textures = {buttonInfo.holdReverse.image .. " Hold 8x4.png"},
				...
				TapNoteSubType_Roll = {
					{
						state_map = inactiveState,
						textures = {buttonInfo.rollReverse.image .. " Roll 8x4.png"},
