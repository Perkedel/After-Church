...
return function(button_list, stepstype, skin_parameters)
	local ret= {}
	local rots= {Left= 90, Down= 0, Up= 180, Right= 270, --rotates the receptors
		     DownLeft= 45, UpLeft= 135, Center= 0, UpRight= 225, DownRight= 315,
