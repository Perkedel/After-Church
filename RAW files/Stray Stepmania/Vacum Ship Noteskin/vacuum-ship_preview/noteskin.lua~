...
-- nix and his trix suggest that I have to start back again myself. He said that is more effective way to get contribution than just proposing an idea.
-- So, let me simplify these all first and add s'more stuffs to it and get in the business.
return {
	notes= "notes.lua", --Loads the main note sprite. 
	layers= {"receptors.lua", "explosions.lua"}, --Loads the layer sprite: Receptor and Explosion animations
	supports_all_buttons= true, -- Settle this noteskin to support all buttons defined
	buttons= {--list of Gamemodes: (credit to Hanubeki for his noteskin.lua)
		  --Define which buttons supported if you set the supports_all_buttons to false.
		  --In this case let's just list them all..
                   "Left", "Down", "Up", "Right", --dance

                   "UpLeft", "UpRight", "DownLeft", "DownRight", "Center", --pump

                   "FootUpLeft", "HandLrLeft", "HandUpLeft", "FootDown", "HandUpRight", "HandLrRight", "FootUpRight",  -- ds3ddx
		   ...
		   "DownLeftFoot", "LeftFoot", "UpLeftFoot", "UpLeftFist", "LeftFist", "DownLeftFist", "DownRightFist",
                   "RightFist", "UpRightFist",   "UpRightFoot", "RightFoot", "DownRightFoot", --Kickbox
                  },
	fallback= "default", --Set the fallback noteskin to load that set for this noteskin has non-existing sprites such as holds and roll.
	player_colors= {{.8, 0, 0, 1}, {0, 0, .8, 1}, {.8, .8, 0, 1},
		        {.4, 0, .8, 1}, {.8, 0, .8, 1}, {.8, .4, 0, 1}},
			--Define mask colors for each players if the gamemode uses player color such as routine.
