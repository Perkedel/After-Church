...
return function(button_list, stepstype)
	...
	local rots= {Left= 90, Down= 0, Up= 180, Right= 270,
		     ...
		     DownLeft= 45, DownRight= 315,  Center= 0,
	}
	local hold_flips= {
		Left= "TexCoordFlipMode_None", Right= "TexCoordFlipMode_X",
		Down= "TexCoordFlipMode_None", Up= "TexCoordFlipMode_Y",
		UpLeft= "TexCoordFlipMode_None", UpRight= "TexCoordFlipMode_X", --add from Jousway
	}
	local roll_flips= {
		Left= "TexCoordFlipMode_None", Right= "TexCoordFlipMode_X",
	...
	local tap_redir= { --copy from Jousway exactV2, to redirect the sprite load of the note
		Left= "down", Right= "down", Down= "down", Up= "down", 
		UpLeft= "down", UpRight= "down", -- shared for dance and pump -Jousway-; sorry bro, I was too lazy to make special note :P
		DownLeft= "down", DownRight= "down", Center= "Center" -- so I just redirect them to "down", except... nvm. -JOELwindows7-
	}
	local hold_redir= { --copy from Jousway exactV2, to redirect the sprite load of the hold bar
		Left= "down", Right= "down", Down= "down", Up= "down", 
		UpLeft= "Center", UpRight= "Center", -- shared for dance and pump -Jousway-
		DownLeft= "Center", DownRight= "Center", Center= "Center" -- well, this is gonna be complex. HELP! -JOELwindows7-
	}
	local tap_width= { --copy from Jousway exactV2, to define the note width
		Left= 64, Down= 64, Up= 64, Right= 64,
		UpLeft= 48, UpRight= 48, 
		DownLeft= 48, DownRight= 48,  Center= 48
	}

	local hold_length= { --copy from Jousway USWDefault9, define hold length
		start_note_offset= 0,
		end_note_offset= 0.5,
		head_pixs= 64,
		body_pixs= 128,
	...
	local roll_length= { --copy from Jousway USWDefault9, define roll length
		start_note_offset= 0,
		end_note_offset= 0.5,
		head_pixs= 64,
		body_pixs= 128,
